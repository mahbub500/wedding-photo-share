...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'weadding-photo-share' ),
		'products'			=> __( 'Products', 'weadding-photo-share' ),
		'order_total'		=> __( 'Order Total', 'weadding-photo-share' ),
		'commission'		=> __( 'Commission', 'weadding-photo-share' ),
		'payment_status'	=> __( 'Payment Status', 'weadding-photo-share' ),
		'time'				=> __( 'Time', 'weadding-photo-share' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'weadding-photo-share' ),
		'draft'		=> __( 'Draft', 'weadding-photo-share' ),
	],
];
